...
x_label_text = 'Changes in Annual Deaths (persons)'
...
legend_elements = [
    ...
    mpatches.Patch(color=colors['Total']['abs_syn'], label='Synergy (Total)'),
    mpatches.Patch(color=colors['Urban']['abs_syn'], label='Synergy (Urban)'),
